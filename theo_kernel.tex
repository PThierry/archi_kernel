...
%% Last update Wed Sep 29 16:14:28 2010 Philippe THIERRY
%%
...
(Hardware-based Virtual-machine Monitor, s'appuyant sur des composant matériels tels que Intel VT
ou ARM TrustZone).
...
\begin{figure}[ht]
\input{pictures/unix_history.tex}
