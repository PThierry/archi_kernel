...
%% Last update Wed Oct 13 18:03:07 2010 Philippe THIERRY
%%
...
\paragraph{}
SELinux, SMAC et Tomoyo\\
Le support des TPM\\
Introduction à GRSecurity

\paragraph{}
La cryptographie : les algos crypto et la glue associée

\subsection{Les pilotes de périphériques}
\paragraph{}
Les classes de périphériques\\
Les différents types de pilotes. Introduction au LDD\\
Udev et la configuration des fichiers devices
